        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/landing/packages" className="text-muted-foreground hover:text-primary transition-colors">
                  {t('nav.packages') || 'الباقات'}
                </Link>
              </li>
              <li>
                <Link href="/landing/umrah-offices" className="text-muted-foreground hover:text-primary transition-colors">
                  {t('nav.offices') || 'مكاتب العمرة'}
                </Link>
              </li>
              <li>
                <Link href="/landing/how-it-works" className="text-muted-foreground hover:text-primary transition-colors">
                  {t('nav.howItWorks') || 'كيف نعمل'}
                </Link>
              </li>
              <li>
                <Link href="/landing/about-us" className="text-muted-foreground hover:text-primary transition-colors">
                  {t('nav.aboutUs') || 'من نحن'}
                </Link>
              </li>
              <li>
                <Link href="/landing/contact" className="text-muted-foreground hover:text-primary transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href={`/${locale}/landing/terms`} className="text-muted-foreground hover:text-primary transition-colors">
                  {t('footer.termsOfService') || 'شروط الخدمة'}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/landing/privacy`} className="text-muted-foreground hover:text-primary transition-colors">
                  {t('footer.privacyPolicy') || 'سياسة الخصوصية'}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/landing/cookie-policy`} className="text-muted-foreground hover:text-primary transition-colors">
                  {t('footer.cookiePolicy') || 'سياسة ملفات تعريف الارتباط'}
                </Link>
              </li>
              <li>
                <Link href={`/${locale}/landing/license-agreement`} className="text-muted-foreground hover:text-primary transition-colors">
