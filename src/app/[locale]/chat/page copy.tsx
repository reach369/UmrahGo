...
export default async function UnifiedChatPage({ params }: { params: { locale: string } }) {
  ...
  useEffect(() => {
    ...
    loadChats();
  }, [user, userType, locale, router, t, activeChat]);
      ...
      <div className="flex-1 flex flex-col h-full">
        {activeChat ? (
          <RealtimeChatContainer
            ...
            chatInfo={activeChat}
            recipientName={activeChat.title || activeChat.recipient?.name}
            recipientAvatar={activeChat.recipient?.profile_photo_path}
            userType={userType as "pilgrim" | "admin" | "office" | "bus_operator" | undefined}
          ...
          <div className="flex flex-col items-center justify-center h-full text-center p-8">
            ...
            {/* Mobile: Show chat list button */}
            <div className="md:hidden mt-8">
              <Button onClick={() => router.push(`/${locale}/chat/list`)}>
                {t('view_chats')}
              </Button>
            </div>
          </div>
