...
export const mockBookingsData: Booking[] = [
  {
    id: 'booking-1',
    user: { name: 'أحمد محمد', contact: '+966501234567', email: 'ahmed@example.com' },
    busId: 'bus-1',
  ...
  {
    id: 'booking-2',
    user: { name: 'فاطمة علي', contact: '+966502345678', email: 'fatima@example.com' },
    busId: null,
    campaignId: 'campaign-1',
  ...
  {
    id: 'booking-3',
    user: { name: 'محمد حسن', contact: '+966503456789', email: 'mohammed@example.com' },
    busId: 'bus-2',
  ...
  {
    id: 'booking-4',
    user: { name: 'عائشة سالم', contact: '+966504567890', email: 'aisha@example.com' },
    busId: null,
    campaignId: 'campaign-1',
  ...
  {
    id: 'booking-5',
    user: { name: 'خالد عبدالله', contact: '+966505678901', email: 'khalid@example.com' },
    busId: 'bus-3',
  ...
  {
    id: 'booking-6',
    user: { name: 'مريم أحمد', contact: '+966506789012', email: 'maryam@example.com' },
    busId: 'bus-2',
    campaignId: 'campaign-2',
  ...
  {
    id: 'booking-7',
    user: { name: 'يوسف ناصر', contact: '+966507890123', email: 'youssef@example.com' },
    busId: 'bus-1',
    campaignId: 'campaign-1',
    bookingDate: '2023-03-15',
    totalPrice: 5000,
  ...
  {
    id: 'booking-8',
    user: { name: 'نورا محمد', contact: '+966508901234', email: 'nora@example.com' },
    busId: null,
  ...
  {
    id: 'booking-9',
    user: { name: 'سعد الغامدي', contact: '+966509012345', email: 'saad@example.com' },
    busId: 'bus-4',
    campaignId: 'campaign-1',
  ...
  {
    id: 'booking-10',
    user: { name: 'هند العتيبي', contact: '+966500123456', email: 'hind@example.com' },
    busId: 'bus-2',
    campaignId: 'campaign-3',
