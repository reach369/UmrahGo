import { useGetGalleryQuery, useDeleteImageMutation, useUpdateImageMutation } from '../redux/api/galleryApiSlice';
...
export function GalleryList() {
  ...
  const handleFeatured = async (id: number) => {
    try {
      await updateImage({ id, is_featured: true } as any).unwrap();
      toast({
