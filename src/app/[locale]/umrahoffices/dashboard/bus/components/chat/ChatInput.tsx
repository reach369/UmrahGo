...
export const ChatInput: React.FC<ChatInputProps> = ({ onSendMessage, isLoading }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="border-t dark:border-gray-700  dark:bg-gray-900 p-4">
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1">
          <input
            ...
            className="w-full px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-white"
            dir="rtl"
          />
        </div>
        <button
