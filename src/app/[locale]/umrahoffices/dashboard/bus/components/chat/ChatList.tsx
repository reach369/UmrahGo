...
export const ChatList: React.FC<ChatListProps> = ({
  ...
  const getStatusIcon = (status?: 'sent' | 'delivered' | 'read') => {
    switch (status) {
      ...
      case 'delivered':
        return <div className="flex"><FiCheck className="text-blue-400 w-4 h-4" /><FiCheck className="text-blue-400 w-4 h-4 -ml-1" /></div>;
      case 'read':
  ...
  return (
    <div className="h-full  dark:bg-gray-900 border-l dark:border-gray-700">
              ...
              <div className="mt-1 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                  {unreadCounts[chat.id] > 0 && (
                    <span className="bg-blue-500 text-white text-xs rounded-full px-2 py-1 min-w-[1.25rem]">
