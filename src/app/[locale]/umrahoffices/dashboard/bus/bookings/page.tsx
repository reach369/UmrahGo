...
export default function BusBookingsPage() {
      ...
      accessor: (booking: BusBooking) => (
        <div className="relative">
          ...
          {isDropdownOpen === booking.id.toString() && (
            <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg  dark:bg-gray-800 ring-1 ring-black ring-opacity-5 z-10">
              <div className="py-1">
                <Link
  ...
  return (
    <div className="container mx-auto py-8">
      ...
      {/* Filters and Search */}
      <div className=" dark:bg-gray-800 rounded-lg shadow p-4 mb-6">
          ...
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
            <div className="relative w-full md:w-64">
              ...
              <input
                ...
                className="block w-full pr-10 py-2 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500  dark:bg-gray-700 dark:text-gray-300"
                value={searchQuery}
            ...
            <div className="relative">
              <select
                ...
                className="block w-full py-2 pl-10 pr-3 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-blue-500 focus:border-blue-500  dark:bg-gray-700 dark:text-gray-300"
              >
