...
// const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'https://www.admin.umrahgo.net/api';
// const API_STORAGE_URL = process.env.NEXT_PUBLIC_API_STORAGE_URL || 'https://www.admin.umrahgo.net/storage/';
...
//     rating: 4.8,
//     reviews_count: 125,
//     gallery: ["https://placehold.co/600x400?text=Gallery1", "https://placehold.co/600x400?text=Gallery2"],
//     is_featured: true,
//     services: ["تنظيم رحلات العمرة، حجز الفنادق، توفير المواصلات"],
...
//     rating: 4.5,
//     reviews_count: 90,
//     gallery: ["https://placehold.co/600x400?text=Gallery3"],
//     is_featured: true,
//     services: ["باقات عمرة متكاملة، إقامة فندقية، زيارات للأماكن المقدسة"],
//     created_at: "2023-01-01T00:00:00.000Z",
//     updated_at: "2023-01-01T00:00:00.000Z"
//   },
//   {
...
//     gallery: [],
//     is_featured: false,
//     services: ["باقات عمرة اقتصادية وفاخرة، إرشاد ديني، زيارات تاريخية"],
//     created_at: "2023-01-01T00:00:00.000Z",
//     updated_at: "2023-01-01T00:00:00.000Z"
//   }
// ];
...
//     const response = await fetch(`${API_BASE_URL}/v1/public/offices?${queryParams.toString()}`);
...
//     const response = await fetch(`${API_BASE_URL}/v1/public/offices/${officeId}`);
